...
Um diese Beiträge einzeln sichtbar zu machen, nähert man die [[Dirac-Gleichung]] durch eine Reihenentwicklung an und erhält damit Korrekturterme zum nicht-relativistischen [[Hamiltonoperator]] $H_0$. Abgesehen von der konstanten Ruheenergie $\displaystyle m_{\mathrm {e} }c^{2}$ des Elektrons lautet der Hamiltonoperator dann in erster Ordnung:
