...
Können unter bestimmten Bedingungen (Wachstum, Krankheit, hartes Training) essenziell werden.
- *Beispiele:* Arginin, Glutamin.

### 3. Nicht-essenzielle Aminosäuren
Der Körper kann sie aus anderen Stoffen selbst synthetisieren.
- *Beispiele:* Alanin, Asparagin, Serin.

## ⚡ Die BCAAs (Branched-Chain Amino Acids)
...
| Aminosäure | Funktion |
| :--- | :--- |
| **Leucin** | Triggert die Proteinsynthese ($mTOR$). |
| **Isoleucin** | Unterstützt die Energieversorgung und Fettverbrennung. |
| **Valin** | Wichtig für die Glykogensynthese und die Nervenfunktion. |

## 🧪 Qualitätsmerkmale von Proteinen

### Biologische Wertigkeit ($BW$)
Gibt an, wie effizient ein Nahrungsprotein in körpereigenes Protein umgewandelt werden kann. Das Vollei dient hierbei oft als Referenzwert ($100$).
- **Whey Protein:** ~$104$
- **Milch (Casein):** ~$88$
- **Rindfleisch:** ~$80$
- **Sojaprotein:** ~$84$
...
- **EAA-Supplements:** Sinnvoll während eines sehr langen Trainings oder bei einer sehr proteinarmen veganen Mahlzeit, um das Aminosäurenprofil aufzuwerten.