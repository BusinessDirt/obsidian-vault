...
## Linearform, Dualraum
Sei $V$ ein $K$-Vektorraum und $f : V \to K$ eine lineare Abbildung. In diesem Fall nennt man $f$ Linearform, $1$-Form oder lineares Funktional auf $V$. Die Menge aller Linearformen auf $V$ bezeichnet man mit $V^*$. Man nennt $V^*$ den Dualraum von $V$.
