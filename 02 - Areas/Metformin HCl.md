...
Metformin wirkt primär durch die Aktivierung der **AMP-aktivierten Proteinkinase (AMPK)**. Dies führt zu:
1. Hemmung der hepatischen Glukoneogenese (Zuckerneubildung in der Leber).
2. Verbesserung der Insulinsensitivität im peripheren Gewebe (Muskeln).
3. Verzögerung der Glukoseaufnahme im Darm.
Es verursacht im Gegensatz zu Sulfonylharnstoffen keine Hypoglykämie.

## Anwendung und Indikation
- **Medizinisch:** First-Line-Therapie bei Typ-2-Diabetes, Behandlung des Polyzystischen Ovarsyndroms (PCOS).
